...
CLI em TypeScript para gerar pirâmides no terminal, explorando lógica, entrada de dados e fundamentos de ferramentas de linha de comando.
...
- Geracao de piramides no terminal.
- Entrada de dados para controlar o resultado.
- Execucao via linha de comando.
- Projeto para praticar fundamentos de CLI.
...
- Ferramenta CLI em TypeScript.
- Logica de construcao de saida textual no terminal.
- Projeto simples para praticar entrada, processamento e saida.
